...
using ElmahCore.Mvc;
using ElmahCore;
using testcomponent.Api.Filters;
using testcomponent.Business.Installer;

namespace testcomponent.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "testcomponent API", Version = version + "-" + branch});
            });

...
using ElmahCore.Mvc;
using ElmahCore;
using serviceone.Api.Filters;
using serviceone.Business.Installer;

namespace serviceone.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "serviceone API", Version = version + "-" + branch});
            });
